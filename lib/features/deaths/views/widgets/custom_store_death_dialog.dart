...
Future<dynamic> showStoreDeathDialog(BuildContext context, String id) {
        ...
        actions: [
          BlocConsumer<DeathsCubit, DeathsState>(
            listener: (context, state) {
              if(state is StoreDeathSuccessState){
            ...
            builder: (context, state) {
              return CustomButton(
                function: () {
                  ...
                  print(id);
                  DeathsCubit.get(context).storeDeath(id: int.parse(id),
