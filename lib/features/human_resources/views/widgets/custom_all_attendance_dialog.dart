...
Future<dynamic> showAllAttendanceDialog(BuildContext context, AllAttendanceInDateModel allAttendanceModel){
  return showDialog(
    context: context,
      ...
      return AlertDialog(
        ...
        content: SizedBox(
          ...
          child: ListView.builder(
            shrinkWrap: true,
            itemCount: allAttendanceModel.allAttInDate!.length,
            itemBuilder: (context, index) {
              var model = allAttendanceModel.allAttInDate![index];
              return Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Spacer(),
                      titleText(allAttendanceModel.allAttInDate![index].id.toString(), color: defaultDarkColor, size: 18),
                      const SizedBox(width: Sizes.spaceBtwItems),
