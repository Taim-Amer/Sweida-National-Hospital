...
Future<dynamic> showCustomAllPenaltyDialog(BuildContext context, AllPenaltyInDateModel allPenaltyModel){
  return showDialog(
    context: context,
      ...
      return AlertDialog(
        ...
        content: SizedBox(
          ...
          child: ListView.builder(
            shrinkWrap: true,
            itemCount: allPenaltyModel.allPenaltyInDate!.length,
            itemBuilder: (context, index) {
              var model = allPenaltyModel.allPenaltyInDate![index];
              return Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Spacer(),
                      titleText(allPenaltyModel.allPenaltyInDate![index].id.toString(), color: defaultDarkColor, size: 18),
                      const SizedBox(width: Sizes.spaceBtwItems),
