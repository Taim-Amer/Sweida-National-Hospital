...
Future<dynamic> showCustomMedicalStoreFileDialog(BuildContext context, String name, String endDate, String company, String quantity){
  return showDialog(
    context: context,
    builder: (context) {
      return AlertDialog(
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Center(child: titleText(endDate, size: 16)),
              ),
              const SizedBox(
                height: Sizes.spaceBtwItems,
              ),
              Container(
                ...
                child: Center(child: titleText(company, size: 16)),
              ),
              const SizedBox(
                height: Sizes.spaceBtwItems,
              ),
