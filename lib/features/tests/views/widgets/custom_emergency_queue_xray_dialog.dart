...
import 'package:hospital_management_system/features/tests/views/widgets/custom_get_emergency_xray_button.dart';
import 'package:iconsax/iconsax.dart';

Future<dynamic> showEmergencyQueueXrayDialog(BuildContext context, AllEmergencyXrayModel allEmergencyXrayModel) {
  return showDialog(
    context: context,
              ...
              return Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      CustomGetEmergencyXrayButton(patientID: allEmergencyXrayModel.allPatientInEmergencyXRayQueue![index].patientId ?? 0,),
                      const Spacer(),
                      titleText(allEmergencyXrayModel.allPatientInEmergencyXRayQueue![index].patient!.fullName ?? "", color: defaultDarkColor, size: 18),
