...
class CustomGetRegularTestButton extends StatelessWidget {
  const CustomGetRegularTestButton({super.key, required this.patientID});
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<TestsCubit, TestsState>(
        ...
        builder: (context, state) {
          return CustomButton(
            function: () {
              TestsCubit.get(context).getRegularTest(patientID: patientID);
            },
            text: "قبول",
            width: 90,
            color: Colors.green,
